...
public class Mapset {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `mappedToTerminology` to the URL query string
    if (getMappedToTerminology() != null) {
      joiner.add(String.format("%smappedToTerminology%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getMappedToTerminology()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
